...
class GamesController extends Controller
{
    ...
    private function formatGameForView(mixed $game)
    {
        return collect($game)->merge([
          ...
          "platforms" => array_key_exists("platforms", $game) ? collect($game["platforms"])->pluck("abbreviation")->implode(", ") : 'N/A', # PS4, PC, Xbox
          ...
          "screenshots" => array_key_exists('screenshots', $game) ? collect($game["screenshots"])->map(fn ($screenshot) => [
